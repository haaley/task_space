...
class EditMeeting extends StatefulWidget {
  ...
  const EditMeeting({Key key, this.id, this.self}) : super(key: key);
...
class _EditMeetingState extends State<EditMeeting> {
                ...
                showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        ...
                        content: Text('Deseja cancelar a edição da Reunião?'),
                        actions: <Widget>[
                          FlatButton(
                              child: Text('Sim'),
                              onPressed: () {
                        ...
                        onPressed: () async {
                          if (formkey.currentState.validate()) {
                            ...
                            if(NewMeetingPageController.instance.statusPost  == '201'){
                              ...
                              SendEmailAlertDialog(context, "Deseja re-enviar email convite para os participantes?");
                            }
  ...
  Future<bool> _onBackPressed() {
    return alertDialog(
        context, "Deseja cancelar a edição da Reunião?", backAction) ??
        false;
  }
}
